...
-- Compatibility keys used by the 3.3.5 settings and chat paths.
...
L["Questie quest automation is enabled. Disable Questie's auto-accept and auto-turn-in so RXPGuides can control guide quest order safely."] = "Questie 任务自动化已启用。请禁用 Questie 的自动接受和自动交付，让 RXPGuides 能够安全地控制指南任务顺序。"
